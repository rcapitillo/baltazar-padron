...
<!DOCTYPE html PUBLIC "-//W3C//DTD	XHTML 1.0	Transitional//EN"
	...
	<?php
		if (($_SESSION["User"]==null) or ($_SESSION["password"]==null)){
			...
			$p=$_POST["periodo"];
			$id=$n."".$p;
				$sql=" INSERT INTO seccion (id, descripcion, periodo) VALUES ('$id', '$n', '$p')";
				echo "<img src='img/logo revolucion.JPG' border='0' width='100%'/>";
				include "header_menu.php";
					if(mysql_query($sql)){
					echo "<HR/> <p class='titulo2'> La seccion fue registrada con exito </p> <HR/> <br/> <br/>";
				}
						else{
								...
								echo "<form name='registrol' action='registroSeccion.php' method='post'> <table border='0' align='center' width='40%'>
